...
const rooms = [
  { id: 1, category: 'Deluxe Room',      name: 'Garden View Deluxe',       price: 4500,  maxOccupancy: 2, bedType: 'King Size',    size: 320, view: 'Garden View',           desc: 'Overlooks lush gardens. Includes king bed, rain shower, mini bar & private sit-out balcony.', amenities: ['King Bed','Rain Shower','Free WiFi','Flat Screen TV','Mini Bar','Air Conditioning','Room Service','Sit-out Balcony'], image: 'https://images.unsplash.com/photo-1761039265583-9489b4246454?w=800&q=85', badge: null },
  { id: 2, category: 'Deluxe Room',      name: 'Pool View Deluxe',          price: 5000,  maxOccupancy: 2, bedType: 'King Size',    size: 340, view: 'Pool View',             desc: 'Direct infinity pool views with contemporary interiors in warm saffron tones.', amenities: ['King Bed','Pool View','Rain Shower','Free WiFi','Flat Screen TV','Air Conditioning','Mini Fridge'], image: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&q=85', badge: null },
  { id: 3, category: 'Premium Room',     name: 'Premium Courtyard Room',    price: 6000,  maxOccupancy: 3, bedType: 'King + Single', size: 420, view: 'Courtyard View',        desc: 'Elegant room with dedicated seating area and serene courtyard views.', amenities: ['King + Single Bed','Seating Area','Premium Toiletries','Free WiFi','Large LCD TV','Air Conditioning','Safe','Bathtub'], image: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800&q=85', badge: null },
  { id: 4, category: 'Family Room',      name: 'Family Retreat Room',       price: 7500,  maxOccupancy: 4, bedType: 'King + Twin',  size: 520, view: 'Garden View',           desc: 'Spacious layout with master bedroom and separate twin section — perfect for families.', amenities: ['King + Twin Beds','Family Setup','Large Bathroom','Free WiFi','43" Smart TV','Air Conditioning','Kids Welcome Kit'], image: 'https://images.unsplash.com/photo-1566665797739-1674de7a421a?w=800&q=85', badge: null },
  { id: 5, category: 'Suite',            name: 'Royal Garden Suite',        price: 9500,  maxOccupancy: 3, bedType: 'King Size',    size: 650, view: 'Garden & Pool View',    desc: 'Separate living room, private garden terrace, king bed & jacuzzi. Most popular choice.', amenities: ['Separate Living Room','Private Terrace','Jacuzzi','King Bed','Premium Minibar','Butler Service','Free WiFi','Smart TV'], image: 'https://images.unsplash.com/photo-1746549855427-57e6da7040db?w=800&q=85', badge: 'Most Popular' },
  { id: 6, category: 'Executive Suite',  name: 'Presidential Suite',        price: 15000, maxOccupancy: 4, bedType: 'King Size',    size: 900, view: 'Panoramic Resort View', desc: 'Grand living room, private dining, master bath & panoramic resort views. The ultimate luxury.', amenities: ['Grand Living Room','Private Dining','Master Bath','Jacuzzi','Premium Butler','Welcome Amenities','Panoramic Views'], image: 'https://images.unsplash.com/photo-1702014861736-d62834317c5e?w=800&q=85', badge: 'Luxury' },
];
    ...
    >
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 bg-black/30">
          <a href={getWhatsAppURL('booking', `Hello! I am interested in booking the ${room.name} at Ayodhya Resort.`)} target="_blank" rel="noopener noreferrer" className="btn-primary text-sm px-6 py-2.5">Inquire Now</a>
        </div>
      </div>
  ...
  return (
    <>
      <div className="relative h-[60vh] min-h-[420px] flex items-end overflow-hidden">
        <Image src="https://images.unsplash.com/photo-1761039265583-9489b4246454?w=1920&q=90" alt="Ayodhya Resort Rooms" fill className="object-cover" priority sizes="100vw" />
